...
public class MyPoint {
	...
	public static void setDefaultDistanceToleranceSq(double x) throws IllegalArgumentException{
		if(isGreaterThanZero(x))
			distanceToleranceSq = x;
		else
			throw new IllegalArgumentException("Argument must be greater than my margin of " + epsilon + ".");
	}
	
	private static boolean isGreaterThanZero(double x){
		if(x > epsilon)
			return true;
		return false;
	}
